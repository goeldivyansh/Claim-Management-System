package com.mfpe.policyservice.Policy.Service;
...
import com.mfpe.policyservice.Policy.Service.repository.BenefitsRepository;
import com.mfpe.policyservice.Policy.Service.repository.HospitalRepository;
...
public class PolicyServiceApplication implements CommandLineRunner{
	...
	@Autowired
	private MemberPolicyRepository memberRepo;
	...
	public void run(String... args) throws Exception {
		...
		MemberPolicy m1=new MemberPolicy("M101","P1001",2,"23/06/2023","01/02/2012");
